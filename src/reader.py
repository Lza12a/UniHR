...
class Vocabulary(object):
    def __init__(self, vocab_file, num_relations, num_entities, num_ent):
        ...
        self.num_ent = num_ent # for temporal kg
...
def prepare_batch_data(inst, vocabulary: Vocabulary, max_arity, max_seq_length):
    ...
    # if vocabulary.num_entities == vocabulary.num_ent:
    if query_type == -1:
    ...
    #     if mask_label % 2:
    #         mask_output[2:2+vocabulary.num_relations] = True
    #     elif mask_label == 0 or mask_label ==2:
    #         mask_output[2+vocabulary.num_relations:2+vocabulary.num_relations+vocabulary.num_ent] = True
    #     else:
    #         mask_output[2+vocabulary.num_relations+vocabulary.num_ent:] = True
